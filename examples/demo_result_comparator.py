...
def demo_with_real_images():
    ...
    reference_path = "datasets/CSIQ/src_imgs/elk.png"
    blurred_path = "datasets/CSIQ/dst_imgs/blur/elk.BLUR.1.png"
    ...
    configs = [
        ...
        ProcessingConfig(sigma=1.0, t=0.6, lambda_param=5.0),
        ProcessingConfig(sigma=1.0, t=0.3, lambda_param=-3.0),
    ]
